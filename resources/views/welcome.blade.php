            ...
            <div class="row">
                ...
                @foreach ($featured_posts as $featured )
                    ...
                    <div class="card mb-4">
                        ...
                        <a href="#!"><img class="card-img-top" src="{{asset('posts_images/'.$featured->image)}}" alt="..." width="800px" height="350px" /></a>
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-primary" href="{{route('posts.show',$featured->id)}}">Read more →</a>
                        </div>
                        <div>
                            <p class="mb-0 text-muted"><i class="fa fa-clock-o"></i> {{$featured->created_at->format('d.m.Y')}}</p>
                        </div>
                    </div>
                @endforeach
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <!-- Blog post-->
                            <div class="card mb-4">
                                <a href="#!"><img class="card-img-top" src="{{asset('posts_images/'.$post->image)}}" alt="..." width="700px" height="350px" /></a>
                                ...
                                <div class="col-sm-6">
                                    <ul class="list-unstyled mb-0">
                                        <div>
                                            ...
                                            {{-- <h5 class="my-5">{{$category->name}}</h5> --}}

                                        </div>
                                        <div>
                                            <p class="mb-0 text-muted"><i class="fa fa-clock-o"></i> {{$category->created_at->format('d.m.Y')}}</p>
                                        </div>
                                        {{-- <li><a href="#!">HTML</a></li>
